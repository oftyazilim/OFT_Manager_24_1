  ...
  <div class="authentication-inner row m-0">
    ...
    <div class="d-flex col-12 col-lg-4 align-items-center authentication-bg p-sm-12 p-6">
      <div class="w-px-400 mx-auto mt-12 mt-5">
        <h4 class="mb-1">Şifrenizi mi unuttunuz? 🔒</h4>
        <p class="mb-6">Lütfen e-postanızı girin, şifrenizi sıfırlamanız için size dönüş yapalım.</p>
        ...
        <form id="formAuthentication" class="mb-6" action="{{ route('password.email') }}" method="POST">
          ...
          <div class="mb-6">
            ...
            <input type="text" class="form-control @error('email') is-invalid @enderror" id="email" name="email" placeholder="birisi@example.com" autofocus>
            @error('email')
          ...
          <button type="submit" class="btn btn-primary d-grid w-100">Sıfırlama Linki Gönder</button>
        </form>
